    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-musaix-dark">
      ...
      <div className="bg-musaix-card border border-white/10 rounded-2xl p-8 w-full max-w-md relative z-10 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full py-3 bg-white text-black rounded-lg font-bold hover:bg-gray-200 transition-colors mt-2"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-musaix-card text-gray-500">Or continue with</span>
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          Don't have an account? <button onClick={onSwitchToSignUp} className="text-musaix-accent hover:underline font-medium">Sign up</button>
        </div>
